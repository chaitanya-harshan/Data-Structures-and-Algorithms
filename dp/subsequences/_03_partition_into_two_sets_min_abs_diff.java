...
public class _03_partition_into_two_sets_min_abs_diff {
    ...
    // we basically split, generate subsets for each, then see if there exists a value in right such that the 
    // values in left + right is as close to total/2 as possible
    ...
    // --- go down, there's another similar simpler problem
    /*
